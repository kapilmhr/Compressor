package app.frantic.videocompressor;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_CAMERA_PHOTO && resultCode == Activity.RESULT_OK) {
            ...
            Log.d("data",capturedUri.toString() +" --check null");
    ...
    class ImageCompressionAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String filePath = KplCompressor.with(mContext).compress(params[0], new File(params[1]));
            return filePath;
            ...
            try {
                compressBitMap = KplCompressor.with(mContext).getCompressBitmap(params[0], true);
